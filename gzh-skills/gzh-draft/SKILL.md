---
name: gzh-draft
description: "【公众号运营技能 · 推送草稿箱 gzh-draft】通过微信公众号 API 或 Chrome CDP 将文章推送到草稿箱。支持 HTML/Markdown/纯文本的文章推送与多图图文推送，自动上传本地图到微信 CDN。触发词：发布公众号、post to wechat、微信公众号、推草稿箱、图文/文章。"
---
...
test -f .baoyu-skills/gzh-draft/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.baoyu-skills/gzh-draft/EXTEND.md" && echo "user"
```

┌────────────────────────────────────────────────────────┬───────────────────┐
│                          Path                          │     Location      │
├────────────────────────────────────────────────────────┼───────────────────┤
│ .baoyu-skills/gzh-draft/EXTEND.md           │ Project directory │
├────────────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.baoyu-skills/gzh-draft/EXTEND.md     │ User home         │
└────────────────────────────────────────────────────────┴───────────────────┘
...
```bash
# Check if gzh-html exists
test -f skills/gzh-html/SKILL.md && echo "found"
```
...
https://github.com/JimLiu/baoyu-skills/blob/main/skills/gzh-html/SKILL.md
...
- A markdown-to-html skill (e.g., `gzh-html`)
...
| Issue | Solution |
|-------|----------|
| No markdown-to-html skill | Install `gzh-html` from suggested URL |
