...
description: First-time setup flow for gzh-draft preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.baoyu-skills/gzh-draft/EXTEND.md` | Current project |
| User | `~/.baoyu-skills/gzh-draft/EXTEND.md` | All projects |
