...
description: "【公众号运营技能 · 插图/图解 gzh-illustration】为公众号文章生成图解插画与带标注配图（默认 16:9，暖色黏土风可选）。从文章/笔记/图表数据提取概念，产出 process/loop/system 等结构化解释图与数据美化图。触发词：配图、带字插图、解释图、图解插画、概念拆解图、图表美化、数据图美化、3D 图表、内容配图、process/loop/system diagrams。"
---
